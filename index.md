...
### [1.2.3](#i1.2.3) <a name='1.2.3'></a>. 서브 컨셉 3 : 행동 유도

![image](https://user-images.githubusercontent.com/91234790/139169678-b3ae0f00-5d1b-4a92-8e9b-683669ca21e2.png)

게임내부에서 직접적으로 무언가를 하라고 하지는 않지만, 이렇게 저렇게 행동하라고 유도 하는 방식을 이용

### [1.2.4](#i1.2.4) <a name='1.2.4'></a>. 서브 컨셉 4 : 단순 그래픽. 개발 인원이 적은 만큼 단순한 그래픽으로 만든다.
...
### [1.2.5](#i1.2.5) <a name='1.2.5'></a>. 서브 컨셉 5 : 무기개조. 자유롭고 자신에게 맞는 무기를 만들 수 있다.
...
### [1.2.6](#i1.2.6) <a name='1.2.6'></a>. 서브 컨셉 6 : 부드러운 움직임. 생각하는데로 움직임이 되어야 한다.
...
위기가 온 세상을 위해 영웅이 되려고 가상세계에서 자신을 단련하는 이야기.
...
- 다 해치우면 다음 스테이지를 로딩하고, 로딩이 다 되면 문이 열린다
